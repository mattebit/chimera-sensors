...
Drivers/STM32F4xx_HAL_Driver/Src/%.o: ../Drivers/STM32F4xx_HAL_Driver/Src/%.c
	...
	@echo $(PWD)
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -DUSE_HAL_DRIVER -DSTM32F446xx '-D__weak=__attribute__((weak))' '-D__packed="__attribute__((__packed__))"' -I"/media/usr/label/Programmazione/STM/Barcellona/Spada/FRONTAL/Inc" -I"/media/usr/label/Programmazione/STM/Barcellona/Spada/FRONTAL/Drivers/STM32F4xx_HAL_Driver/Inc" -I"/media/usr/label/Programmazione/STM/Barcellona/Spada/FRONTAL/Drivers/STM32F4xx_HAL_Driver/Inc/Legacy" -I"/media/usr/label/Programmazione/STM/Barcellona/Spada/FRONTAL/Drivers/CMSIS/Device/ST/STM32F4xx/Include" -I"/media/usr/label/Programmazione/STM/Barcellona/Spada/FRONTAL/Drivers/CMSIS/Include"  -O3 -g3 -Wall -fmessage-length=0 -ffunction-sections -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
