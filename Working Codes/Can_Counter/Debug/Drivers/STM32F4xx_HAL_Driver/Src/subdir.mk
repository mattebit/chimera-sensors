...
Drivers/STM32F4xx_HAL_Driver/Src/%.o: ../Drivers/STM32F4xx_HAL_Driver/Src/%.c
	...
	@echo $(PWD)
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 '-D__weak=__attribute__((weak))' '-D__packed="__attribute__((__packed__))"' -DUSE_HAL_DRIVER -DSTM32F446xx -I"/media/usr/label/Programmazione/STM/MINE/Can_Counter/Inc" -I"/media/usr/label/Programmazione/STM/MINE/Can_Counter/Drivers/STM32F4xx_HAL_Driver/Inc" -I"/media/usr/label/Programmazione/STM/MINE/Can_Counter/Drivers/STM32F4xx_HAL_Driver/Inc/Legacy" -I"/media/usr/label/Programmazione/STM/MINE/Can_Counter/Drivers/CMSIS/Device/ST/STM32F4xx/Include" -I"/media/usr/label/Programmazione/STM/MINE/Can_Counter/Drivers/CMSIS/Include"  -Og -g3 -Wall -fmessage-length=0 -ffunction-sections -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
